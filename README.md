...
> [!NOTE]   
> Por exemplo, a URL https://github.com/falvojr/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`falvojr`" para a contribuição no repositório `dio-lab-open-source`.: 'git checkout -b dio-lab-open-source`
> Exemplo: 'git checkout -b dio-lab-open-source`
